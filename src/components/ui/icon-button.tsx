  ...
  ({ title, destructive, className, children, ...props }, ref) => {
    return (
      <button
        ...
        aria-label={title}
        className={cn(
          "flex h-10 w-10 items-center justify-center rounded-full transition-[background-color,transform] duration-150 ease-out hover:scale-105 active:scale-90 md:h-8 md:w-8",
